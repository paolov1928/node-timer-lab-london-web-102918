// let numberOfSeconds = parseInt(process.argv[2].replace(/[^0-9]/g, ""))

// // for (i = numberOfSeconds; i > 0; i--) {
// //   console.log(i)
// //   global.setInterval(() => "hi", 1000)
// // }

// myVar = global.setInterval(() => console.log(`Left: ${numberOfSeconds}s`), 1000)
// global.clearInterval(myVar)
